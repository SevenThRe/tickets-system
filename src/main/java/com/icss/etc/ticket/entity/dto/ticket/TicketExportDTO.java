...
public class TicketExportDTO {
    ...
    @ExcelColumn(value = "处理部门", index = 3, width = 20)
    ...
    @ExcelColumn(value = "创建时间", index = 7, width = 20, dateFormat = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime createTime;

    @ExcelColumn(value = "期望完成时间", index = 8, width = 20, dateFormat = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime expectFinishTime;

    @ExcelColumn(value = "实际完成时间", index = 9, width = 20, dateFormat = "yyyy-MM-dd HH:mm:ss")
